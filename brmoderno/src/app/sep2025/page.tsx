...
export default function Sep2025Page() {
  return (
    <main className="min-h-screen bg-gray-100 font-[Poppins] flex flex-col items-center">
      <section className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8 mt-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-3xl font-bold ml-4">Septiembre 2025</h1>
        </div>
          ...
          <table className="min-w-full border border-gray-300 rounded-lg text-center">
            <thead className="bg-blue-100">
              <tr>
                ...
                <th className="px-4 py-2">S1/9</th>
                <th className="px-4 py-2">S8/9</th>
                <th className="px-4 py-2">S15/9</th>
                <th className="px-4 py-2">S22/9</th>
                <th className="px-4 py-2">S29/9</th>
              </tr>
            </thead>
            <tbody>
              <tr>
