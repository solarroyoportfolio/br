...
export default function Mayo25Page() {
  return (
    <main className="min-h-screen bg-gray-100 font-[Poppins] flex flex-col items-center">
      <section className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8 mt-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-3xl font-bold ml-4">Mayo 2025</h1>
        </div>
          ...
          <table className="min-w-full border border-gray-300 rounded-lg text-center">
            <thead className="bg-blue-100">
              <tr>
                ...
                <th className="px-4 py-2">S5/05</th>
                <th className="px-4 py-2">S12/05</th>
                <th className="px-4 py-2">S19/05</th>
                <th className="px-4 py-2">S26/05</th>
              </tr>
            </thead>
            <tbody>
              <tr>
