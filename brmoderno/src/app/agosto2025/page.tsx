...
export default function Agosto2025Page() {
  return (
    <main className="min-h-screen bg-gray-100 font-[Poppins] flex flex-col items-center">
      <section className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8 mt-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-3xl font-bold ml-4">Agosto 2025</h1>
        </div>
          ...
          <table className="min-w-full border border-gray-300 rounded-lg text-center">
            <thead className="bg-blue-100">
              <tr>
                ...
                <th className="px-4 py-2">S4/08</th>
                <th className="px-4 py-2">S11/08</th>
                <th className="px-4 py-2">S18/08</th>
                <th className="px-4 py-2">S25/08</th>
              </tr>
            </thead>
            <tbody>
              <tr>
